...
rare listing erc1155 buy --contract <address> --token-id <id> --seller <address> --quantity <number> --price <amount> [--currency <currency>] [--yes] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 checkout --input <file> [--yes] [--chain <chain>] [--chain-id <id>]
...
rare listing erc1155 release mint --contract <address> --token-id <id> --quantity <number> [--currency <currency>] [--price <amount>] [--proof <file>] [--yes] [--chain <chain>] [--chain-id <id>]
