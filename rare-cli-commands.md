...
rare collection deploy erc1155 <name> <symbol> --base-uri <uri> [--chain <chain>] [--chain-id <id>]
...
rare collection royalty set-default-percentage --contract <address> --percentage <number> [--chain <chain>] [--chain-id <id>]
rare collection royalty set-token-receiver --contract <address> --token-id <id> --receiver <address> [--chain <chain>] [--chain-id <id>]

rare collection erc1155 create-token --contract <address> --max-supply <number> [--token-uri <uri>] [--royalty-receiver <address>] [--chain <chain>] [--chain-id <id>]
rare collection erc1155 mint --contract <address> --token-id <id> --quantity <number> [--to <address>] [--chain <chain>] [--chain-id <id>]
rare collection erc1155 mint-batch --contract <address> --input <file> [--to <address>] [--chain <chain>] [--chain-id <id>]
rare collection erc1155 metadata update-token-uri --contract <address> --token-id <id> --token-uri <uri> [--chain <chain>] [--chain-id <id>]
rare collection erc1155 disable --contract <address> [--chain <chain>] [--chain-id <id>]
rare collection erc1155 minter set --contract <address> --minter <address> --approved <true|false> [--chain <chain>] [--chain-id <id>]
rare collection erc1155 status --contract <address> [--token-id <id>] [--account <address>] [--chain <chain>] [--chain-id <id>]
...
rare listing erc1155 create --contract <address> --token-id <id> --quantity <number> --price <amount> [--currency <currency>] [--split <addr=ratio>] [--expiration-time <time>] [--yes] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 create-batch --contract <address> --input <file> [--currency <currency>] [--split <addr=ratio>] [--yes] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 buy --contract <address> --token-id <id> --seller <address> --quantity <number> --price <amount> [--currency <currency>] [--recipient <address>] [--yes] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 checkout --input <file> [--recipient <address>] [--yes] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 cancel --contract <address> --token-id <id>... [--chain <chain>] [--chain-id <id>]
rare listing erc1155 status --contract <address> --token-id <id> --seller <address> [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release configure --contract <address> --token-id <id> --price <amount> --max-mints <number> [--currency <currency>] [--start-time <time>] [--split <addr=ratio>] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release configure-batch --contract <address> --input <file> [--currency <currency>] [--split <addr=ratio>] [--yes] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release cancel --contract <address> --token-id <id>... [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release mint --contract <address> --token-id <id> --quantity <number> [--currency <currency>] [--price <amount>] [--proof <file>] [--recipient <address>] [--yes] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release status --contract <address> --token-id <id> [--account <address>] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release allowlist build --input <file> [--format <format>] [--output <file>]
rare listing erc1155 release allowlist proof --input <file> --account <address> [--output <file>]
rare listing erc1155 release allowlist set --contract <address> --token-id <id> --end-time <time> [--input <file>] [--root <bytes32>] [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release allowlist set-batch --contract <address> --input <file> [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release allowlist clear --contract <address> --token-id <id> [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release limits set-mint --contract <address> --token-id <id> --limit <number> [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release limits set-mint-batch --contract <address> --input <file> [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release limits set-tx --contract <address> --token-id <id> --limit <number> [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release limits set-tx-batch --contract <address> --input <file> [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release limits get-mint --contract <address> --token-id <id> [--chain <chain>] [--chain-id <id>]
rare listing erc1155 release limits get-tx --contract <address> --token-id <id> [--chain <chain>] [--chain-id <id>]
...
rare offer erc1155 create --contract <address> --token-id <id> --quantity <number> --price <amount> [--currency <currency>] --expiration-time <time> [--yes] [--chain <chain>] [--chain-id <id>]
rare offer erc1155 accept --contract <address> --token-id <id> --buyer <address> --quantity <number> --price <amount> [--currency <currency>] [--split <addr=ratio>] [--yes] [--chain <chain>] [--chain-id <id>]
rare offer erc1155 cancel --contract <address> --token-id <id> [--currency <currency>] [--chain <chain>] [--chain-id <id>]
rare offer erc1155 status --contract <address> --token-id <id> --buyer <address> [--currency <currency>] [--chain <chain>] [--chain-id <id>]
