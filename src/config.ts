...
import { chainIds, supportedChains, isSupportedChain, type SupportedChain } from '@rareprotocol/rare-sdk/contracts/addresses.js';
import { parsePrivateKey } from '@rareprotocol/rare-sdk/validation.js';
