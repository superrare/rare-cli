...
export const mcpToolSpecs = [
  ...
  sdkTool('write', 'rare.erc20.deploy.sovereign', 'Deploy a Sovereign ERC20 token.'),
  sdkTool('write', 'rare.erc20.deploy.sovereignMarket', 'Deploy a Sovereign ERC20 token with market support.'),
  sdkTool('write', 'rare.erc20.deploy.sovereignMarketRewards', 'Deploy a Sovereign ERC20 token with market rewards support.'),
  sdkTool('read', 'rare.erc20.factoryStatus', 'Read Sovereign ERC20 factory status and availability.'),
  sdkTool('read', 'rare.erc20.status', 'Read Sovereign ERC20 token status.'),
  sdkTool('read', 'rare.erc20.getTokenUri', 'Read a Sovereign ERC20 token URI.'),
  sdkTool('write', 'rare.erc20.delegation.delegate', 'Approve a creator delegate for Sovereign ERC20 operations.'),
  sdkTool('write', 'rare.erc20.delegation.revoke', 'Revoke a creator delegate for Sovereign ERC20 operations.'),
  sdkTool('read', 'rare.erc20.delegation.isDelegate', 'Read whether an address is a creator delegate.'),
  sdkTool('write', 'rare.erc20.mint', 'Mint Sovereign ERC20 token supply.'),
  sdkTool('write', 'rare.erc20.burn', 'Burn Sovereign ERC20 token supply.'),
  sdkTool('write', 'rare.erc20.burnFrom', 'Burn Sovereign ERC20 token supply from an address.'),
  sdkTool('write', 'rare.erc20.updateTokenUri', 'Update a Sovereign ERC20 token URI.'),
  sdkTool('read', 'rare.erc20.rewards.status', 'Read Sovereign ERC20 rewards status.'),
  sdkTool('write', 'rare.erc20.rewards.notify', 'Notify Sovereign ERC20 reward amount.'),
  sdkTool('write', 'rare.erc20.rewards.sync', 'Sync Sovereign ERC20 rewards accounting.'),
  sdkTool('write', 'rare.erc20.rewards.claim', 'Claim Sovereign ERC20 rewards.'),
  sdkTool('write', 'rare.erc20.rewards.exclude', 'Exclude an account from Sovereign ERC20 rewards.'),
  sdkTool('write', 'rare.erc20.rewards.include', 'Include an account in Sovereign ERC20 rewards.'),
  ...
  sdkTool('read', 'rare.search.nfts', 'Search NFTs through the RARE API.'),
  sdkTool('read', 'rare.search.collections', 'Search collections through the RARE API.'),
  sdkTool('read', 'rare.search.events', 'Search NFT events through the RARE API.'),
