...
export function shapeBatchOfferRead(value: BatchOfferReadTuple | BatchOfferRead): BatchOfferRead {
  if (isBatchOfferReadTuple(value)) {
    return {
      creator: value[0],
      rootHash: value[1],
      amount: value[2],
...
function isBatchOfferReadTuple(value: BatchOfferReadTuple | BatchOfferRead): value is BatchOfferReadTuple {
