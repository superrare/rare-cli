...
describe('mcp core helpers', () => {
  it('derives tool inventory by read/write access', () => {
    ...
    expect(mcpReadToolNames).toContain('erc20_factory_status');
    expect(mcpReadToolNames).toContain('erc20_status');
    expect(mcpReadToolNames).toContain('erc20_get_token_uri');
    expect(mcpReadToolNames).toContain('erc20_delegation_is_delegate');
    expect(mcpReadToolNames).toContain('erc20_rewards_status');
    ...
    expect(mcpWriteToolNames).toContain('erc20_deploy_sovereign');
    expect(mcpWriteToolNames).toContain('erc20_deploy_sovereign_market');
    expect(mcpWriteToolNames).toContain('erc20_deploy_sovereign_market_rewards');
    expect(mcpWriteToolNames).toContain('erc20_delegation_delegate');
    expect(mcpWriteToolNames).toContain('erc20_delegation_revoke');
    expect(mcpWriteToolNames).toContain('erc20_mint');
    expect(mcpWriteToolNames).toContain('erc20_burn');
    expect(mcpWriteToolNames).toContain('erc20_burn_from');
    expect(mcpWriteToolNames).toContain('erc20_update_token_uri');
    expect(mcpWriteToolNames).toContain('erc20_rewards_notify');
    expect(mcpWriteToolNames).toContain('erc20_rewards_sync');
    expect(mcpWriteToolNames).toContain('erc20_rewards_claim');
    expect(mcpWriteToolNames).toContain('erc20_rewards_exclude');
    expect(mcpWriteToolNames).toContain('erc20_rewards_include');
  ...
  it('maps SDK paths to SDK-shaped snake_case tool names', () => {
    ...
    expect(sdkPathToMcpToolName('rare.erc20.deploy.sovereign')).toBe('erc20_deploy_sovereign');
    expect(sdkPathToMcpToolName('rare.erc20.deploy.sovereignMarketRewards')).toBe('erc20_deploy_sovereign_market_rewards');
    expect(sdkPathToMcpToolName('rare.erc20.factoryStatus')).toBe('erc20_factory_status');
    expect(sdkPathToMcpToolName('rare.erc20.getTokenUri')).toBe('erc20_get_token_uri');
    expect(sdkPathToMcpToolName('rare.erc20.delegation.isDelegate')).toBe('erc20_delegation_is_delegate');
    expect(sdkPathToMcpToolName('rare.erc20.rewards.notify')).toBe('erc20_rewards_notify');
